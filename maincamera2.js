...
// @version 1.3.1
// @description ADB SAFEGATE Safedock + Wing Camera Mini Player (A350 / 777-300ER, Wing only) - Toggle対応
// @author chi_FUK77W
...
let previousCamMode = -1; // 追加：切り替え前のカメラを記憶
...
#vdgs-miniplayer.active{
 border-color:#00ff88;
 box-shadow:0 0 25px #00ff8866;
}
#vdgs-miniplayer.active .mp-header{color:#00ff88;}
`;
...
<span id="mp-status" style="font-size:11px;opacity:.6">●</span>
</div>
<div class="mp-body">
<div class="title">WING VIEW</div>
<div class="hint">Click to toggle<br>A350 / 777-300ER only</div>
</div>`;
document.body.appendChild(mp);

// ★ ここが変更点：もう一度押すと前のカメラに戻るトグル仕様
mp.onclick = () => {
