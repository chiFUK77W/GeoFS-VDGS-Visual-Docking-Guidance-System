...
// @version      1.3.3
// @description  ADB SAFEGATE Safedock + Wing Camera Mini Player (A350 / 777-300ER, Wing only) - Toggle対応 (Click / Enter) - VT323
// @author       chi_FUK77W
...
#vdgs-type{font-size:28px;color:#ffb000;letter-spacing:1px;text-shadow:0 0 10px #ffb000cc;min-height:36px;line-height:1.3}
...
#vdgs-stop-sign{display:none;width:118px;height:118px;background:#000;color:#ff1a00;font-size:24px;border:6px solid #ff1a00;box-sizing:border-box;clip-path:polygon(30% 0%,70% 0%,100% 30%,100% 70%,70% 100%,30% 100%,0% 70%,0% 30%);align-items:center;justify-content:center;margin:0 auto;box-shadow:0 0 20px #ff1a00b3;text-shadow:0 0 8px #ff1a00;line-height:1}
#vdgs-msg{font-size:20px;letter-spacing:2px;min-height:28px;margin-top:6px;text-shadow:0 0 10px currentColor}
...
#vdgs-miniplayer .mp-body .title{font-size:16px;margin-bottom:8px;text-shadow:0 0 8px #ff8800}
